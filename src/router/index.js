...
export default new Router({
  ...
  },
  {
    ...
    children: [{
      ...
      path: 'customer',
      component: customer,
      meta: {title: '用户列表', bread: ['用户数据', '用户列表']}
    }, {
      path: 'bussiness',
      component: bussiness,
      meta: {title: '商家列表', bread: ['用户数据', '商家列表']}}, {
      path: 'food',
      component: food,
      meta: {title: '食品列表', bread: ['用户数据', '食品列表']}
    }, {
      path: 'order',
      component: order,
      meta: {title: '订单列表', bread: ['用户数据', '订单列表']}}, {
      path: 'admin',
      component: admin,
      meta: {title: '管理员列表', bread: ['用户数据', '管理员列表']}
    }],
    meta: {title: '用户数据', icon: 'document'}
  }, {
    path: '/add',
    component: home,
    children: [{
      path: 'shops',
      component: shops,
      meta: {title: '添加商铺', bread: ['添加数据', '添加商铺']}}, {
      path: 'commodity',
      component: commodity,
      meta: {title: '添加商品', bread: ['添加数据', '添加商品']}
    }],
    meta: {title: '添加数据', icon: 'plus'}
  }, {
    path: '/charts',
    name: 'charts',
    component: home,
    children: [{
      ...
      name: 'userCity',
      component: userCity,
      meta: {title: '用户分布', bread: ['图表', '用户分布']}}],
    meta: {title: '图表', icon: 'star-on'}
  }]
})
